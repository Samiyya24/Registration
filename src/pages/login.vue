...
<template>
  <div
    class="bg-gradient-to-r from-amber-400 to-yellow-400 flex justify-center items-center h-screen"
  >
    <div class="bg-white py-11 px-8 w-[475px] rounded-2xl text-center">
      <img class="mx-auto mb-11 h-10" src="/icons/Logo.svg" alt="" />
      ...
      <form @submit.prevent="loginUser" action="" class="text-left">
        ...
        <button
          class="py-2 bg-gradient-to-r from-amber-400 to-yellow-400 text-white w-full"
        >
          SIGN IN
        </button>
      </form>
      <p class="mt-7 text-[#6C6C6C]">
        ...
        <router-link class="text-[#FEAF00] underline">
